...
\begin{enumerate}[label=\alph*.]
    ...
    \begin{framed}
        Let \( icecream \) be a constant.\\
        \( \exists\;icecream\;\forall\; x: Loves(x,icecream) \)
    \end{framed}
    \item It is not true that everyone loves some ice cream flavor.
    \begin{framed}
        Let \( icecream \) be a constant.\\
        \( \exists\;x\;\forall\;icescrem: \lnot(Loves(x,icecream)) \)
    \end{framed}
    \item Anyone who does not shave himself must be shaved by the barber.
    \begin{framed}
        Let \( barber \) be a constant.\\
        \( \forall x: \lnot(Shaves(x,x)) \Rightarrow  Shaves(barber,x) \)
    \end{framed}
    \item Whomever the barber shaves, must not shave himself.
    \begin{framed}
        Let \( barber \) be a constant.\\
        \( \forall x: Shaves(barber,x) \Rightarrow  \lnot (Shaves(x,x)) \)
    \end{framed}
    \item Rudolph is a reindeer and Rudolph has a red nose.
    \begin{framed}
        Let \( Rudolph \), \( barber \), \( red nose \) be constants.\\
        \( Is(Rudolph,barber) \land Is(Rudolph,red nose) \)
    \end{framed}
    \item Anyone with a red nose is weird or is a clown.
    \begin{framed}
        Let \( weird \), \( clown\) be constants.\\
        \( \forall x:  Is(x,weird) \lor Is(x,clown) \)
    \end{framed}
    \item No reindeer is a clown.
    \begin{framed}
        Let \( reindeer \), \( clown \) be constants.\\
        \( \forall\;reindeer:  \lnot(Is(reindeer,clown)) \)
    \end{framed}
\end{enumerate}
